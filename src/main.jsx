...
const OWNER_WALLET = '0xA89c45b89b0558e866c5B983E27a61Df6b0FA968';
    ...
    <main className="app-shell">
      <section className="hero">
        <div className="hero-copy">
          <span className="eyebrow">1-topshiriq | Sepolia DApp</span>
      ...
      <section className="workspace">
        <div className="panel wallet-panel">
          ...
          <dl className="account-list">
            ...
            <div>
              <dt>Owner</dt>
              <dd>{shortAddress(OWNER_WALLET)}</dd>
            </div>
            <div>
              <dt>Contract</dt>
